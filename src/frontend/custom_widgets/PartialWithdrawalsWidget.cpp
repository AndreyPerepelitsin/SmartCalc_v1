...
PartialWithdrawalsWidget::PartialWithdrawalsWidget(QWidget *parent)
  ...
  addButton = new QPushButton("Add withdrawal", this);
  removeButton = new QPushButton("Remove withdrawal", this);
  ...
  connect(addButton, &QPushButton::clicked, this,
          &PartialWithdrawalsWidget::addLayout);
...
QVBoxLayout *PartialWithdrawalsWidget::getLayout() const { return mainLayout; }
int PartialWithdrawalsWidget::setPartialWithdrawals(
    ...
    if (!errorCode) {
      ...
      if (!errorCode) {
        ...
        if (transactionAmountValue < S21_MIN_TRANSACTION_AMOUNT_VALUE ||
          ...
          addPartialWithdrawalTransaction(depositParams, transactionAmountValue,
                                          rawDate, interval);
        }
      }
    }
...
void PartialWithdrawalsWidget::addLayout() {
...
void PartialWithdrawalsWidget::removeLayout() {
  if (!layouts.isEmpty()) {
