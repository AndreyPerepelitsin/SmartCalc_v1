...
void handleCalculationSubtraction(Data operand1, Data operand2, double *pResult) {
    *pResult = operand1.value - operand2.value;
}

void handleCalculationMultiplication(Data operand1, Data operand2, double *pResult) {
    *pResult = operand1.value * operand2.value;
}
